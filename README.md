...
<hr>
<div  align="center">
<img width="582" alt="Screenshot 2024-01-22 at 15 11 50" src="https://github.com/AbdennourHsn/AutoCar/assets/119530347/daab1f4c-aff5-4b8c-953f-ecedeb058d53">
...
# API Project
https://github.com/AbdennourHsn/AutoCarApi
...
**1-Intergate Unity projet (the 3D envirenement) to Angular**

 Integrate Unity WebGL with an Angular application
 <div align="center">
<img width="681" alt="Screenshot 2024-01-23 at 13 45 59" src="https://github.com/AbdennourHsn/AutoCar/assets/119530347/7b15902a-67b8-41e8-b890-b1e2b4d9d474">

 </div >



**2-Display a 3D model in a window using Angular** 

To display a 3D model in a window using Angular, We use a 3D library. On this project we used one of the popular choices is **Three.js**.

<div align="center">
<img width="235" alt="Screenshot 2024-01-23 at 13 35 14" src="https://github.com/AbdennourHsn/AutoCar/assets/119530347/6a04efce-f8d3-451e-b008-0291fccc282c">
</div>
